final String appName = 'Goods N Service Driver';

// final String baseUrl = 'https://developmentalphawizz.com/goodsnservice/delivery_boy/app/v1/api/';
final String baseUrl = 'https://goodsnservice.com/delivery_boy/app/v1/api/';
