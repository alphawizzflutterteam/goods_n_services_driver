...
const Color primary = Color(0xfffcc53c);
const Color secondary=Color(0xff4609cc);
const Color fontColor=Color(0xff111111);
// const Color grad1Color=Color(0xffFFBD69);
const Color grad1Color=Color(0xfffcc53c);
// const Color grad2Color=Color(0xffFF6363);
const Color grad2Color=Color(0xff4609cc);
...
const Color lightWhite1 = Color(0xff8F4228);
const Color darkColor = Color(0xff8F4228);
const Color darkColor2 = Color(0xff8F4228);
